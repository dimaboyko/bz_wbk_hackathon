module Contracts
  class Creator
    ...
    def perform
      ...
      order.order_items.create(name: 'Pilsner', amount: 10)
      order.order_items.create(name: 'Guiness', amount: 15)
      #order.order_items.create(name: 'Lager', amount: 10)
      order.order_items.create(name: 'Hamburger', amount: 5)
